energy-dome-access-denied = Недостаточный доступ
energy-dome-recharging = Перезарядка...
energy-dome-no-power = Низкий уровень заряда
energy-dome-no-cell = Требуется батарея
...
ent-EnergyDomeGeneratorPersonalNT = поясной генератор барьера
    .desc = Генератор щита, защищающий владельца от лазеров и пуль, но не позволяющий самому использовать оружие дальнего боя. Использует батареи.
